  ...
  return (
    <div className="p-4 space-y-6">
      <div className="text-sm text-muted-foreground">
        The following third-party library classes are skipped during linting when the 3rd Party toggle is enabled. Using
        these classes will not produce violations.
      </div>
