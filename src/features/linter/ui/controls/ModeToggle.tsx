  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          transform: mode === "element" ? "translateX(4px)" : "translateX(calc(100% + 2px))",
        }}
        aria-hidden="true"
      />
      ...
      <button
        ...
        className={cn(
          ...
          mode === "element" ? "text-accent-foreground" : "text-muted-foreground hover:text-foreground"
        )}
      ...
      <button
        ...
        className={cn(
          ...
          "transition-colors duration-200 ease-out",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
          mode === "page" ? "text-accent-foreground" : "text-muted-foreground hover:text-foreground"
        )}
